...
class Ui_primaryFUSEwindow(object):
    ...
    def retranslateUi(self, primaryFUSEwindow):
        ...
        self.bucket_select.setItemText(0, QCoreApplication.translate("primaryFUSEwindow", u"Azure", None))
        self.bucket_select.setItemText(1, QCoreApplication.translate("primaryFUSEwindow", u"S3", None))
...
#endif // QT_CONFIG(tooltip)
        self.bucket_select.setCurrentText(QCoreApplication.translate("primaryFUSEwindow", u"Azure", None))
