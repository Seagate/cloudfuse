## lyvecloudfuse mountv1

Generate a configuration file for Lyvecloudfuse from Blobfuse configuration file/flags
...
```
  ...
  -o, --o strings                              FUSE options.
      ...
      --pre-mount-validate                     Validate lyvecloudfuse is mounted (default true)
